...
const QMetaObject CQPropertyViewDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_CQPropertyViewDelegate.data,
      qt_meta_data_CQPropertyViewDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CQPropertyViewDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CQPropertyViewDelegate.stringdata0))
        return static_cast<void*>(const_cast< CQPropertyViewDelegate*>(this));
