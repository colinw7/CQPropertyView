...
void CQPropertyViewItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CQPropertyViewItem *_t = static_cast<CQPropertyViewItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CQPropertyViewItem::*_t)(QObject * , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CQPropertyViewItem::valueChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CQPropertyViewItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CQPropertyViewItem.data,
      qt_meta_data_CQPropertyViewItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CQPropertyViewItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CQPropertyViewItem.stringdata0))
        return static_cast<void*>(const_cast< CQPropertyViewItem*>(this));
